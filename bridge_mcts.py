...
import sys
from agent_mcts.board import State
from agent_mcts.mcts import mcts_action
from agent_mcts.evaluate import placement_score                                                                                                                                                                                            
    ...
    while not state.game_finished():                                                                                                                                                                                                   
        ...
        if my_turn:                    
            ...
            if state.placement_count < PLACEMENT_TURNS:
                ...
                action, _ = mcts_action(state, time_limit=2.0)   # mcts_action returns (action, root)
